...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> resourceNotFound(ResourceNotFoundException exc, WebRequest request){
            ErrorResponse errorResponse = new ErrorResponse().code(exc.getCode()).message(exc.getErrorMessage());
    ...
    public ResponseEntity<ErrorResponse> unauthorizedException(UnauthorizedException exe,WebRequest request){
        ...
        error.code(exe.getCode());
        error.code(exe.getErrorMessage());
