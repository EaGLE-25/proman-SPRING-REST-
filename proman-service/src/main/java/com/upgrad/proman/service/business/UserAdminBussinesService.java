...
@Service
public class UserAdminBussinesService {
    @Autowired
    UserDao userDao;
    ...
    public UserEntity getUser(String uuid,String authorizationToken) throws ResourceNotFoundException, UnauthorizedException {
        UserAuthTokenEntity userAuthTokenEntity = userDao.getUserAuthToken(authorizationToken);

        if(userAuthTokenEntity == null){
            throw new UnauthorizedException("ATH-003", "Wrong token");
        }
